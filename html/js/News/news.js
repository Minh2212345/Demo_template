...
news[0].HinhAnhChinh = "/html/img/News/FireDinhCongHa.png";
...
news[1].HinhAnhChinh = "/html/img/News/FireTG-1.png";
...
news[1].NoiDung = [
    ...
    { type: "image", content: "/html/img/News/FireTG-2.png", caption: "FireTG-2" },
...
news[2].HinhAnhChinh = "/html/img/News/AGStole-2.png";
...
news[2].NoiDung = [
    ...
    { type: "image", content: "/html/img/News/AGStole-2.png", caption: "AGStole-1" },
...
news[3].HinhAnhChinh = "/html/img/News/stole-2.png";
        ...
        <div class="col mb-5">
            <div class="card h-100">
                ...
                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                    <div class="text-center">
                        <a class="btn btn-outline-dark mt-auto" href="/html/HomePage/NewsDoc.html?maso=${bv.id}">Đọc thêm</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        let productHTML = `
            <div class="col mb-5">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <div class="text-center">
                            <a class="btn btn-outline-dark mt-auto hover-btn" href="/html/HomePage/NewsDoc.html?maso=${sp.id}">Xem chi tiết</a>
                        </div>
                    </div>
                </div>
            </div>
